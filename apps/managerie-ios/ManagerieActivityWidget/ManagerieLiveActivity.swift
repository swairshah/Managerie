...
struct ManagerieLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: ManagerieActivityAttributes.self) { context in
    ...
    @ViewBuilder
    private func lockScreenBanner(context: ActivityViewContext<ManagerieActivityAttributes>) -> some View {
    ...
    private func deepLink(for sessionKey: String) -> URL {
        ...
        return URL(string: "managerie://session/\(encoded)")!
    }
