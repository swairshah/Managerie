...
This app is an iPhone companion for the Managerie macOS host over Tailscale/WebSocket.

It is intentionally isolated under `apps/managerie-ios/` so it can be changed or removed without affecting the macOS app.

## Current features

- Connect to Managerie remote server profiles (`ws://<host>:18092/ws`)
...
- `~/.pi/agent/managerie-inbox-media/<pid>/<timestamp>-<uuid>.jpg`

## Docs

- Setup and run: `apps/managerie-ios/SETUP.md`
