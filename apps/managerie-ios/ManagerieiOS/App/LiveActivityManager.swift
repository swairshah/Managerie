...
/// Manages Live Activities for active Managerie sessions.
...
final class LiveActivityManager {
    ...
    private var activities: [String: Activity<ManagerieActivityAttributes>] = [:]
    ...
    private func startActivity(for session: RemoteSession, serverName: String) {
        ...
        let attributes = ManagerieActivityAttributes(
    ...
    private func endActivity(forKey key: String, summary: String?) {
        ...
        let finalState = ManagerieActivityAttributes.ContentState(
            activity: "waiting",
            activityLabel: "Done",
            currentText: nil,
    ...
    private func contentState(from session: RemoteSession) -> ManagerieActivityAttributes.ContentState {
        ManagerieActivityAttributes.ContentState(
