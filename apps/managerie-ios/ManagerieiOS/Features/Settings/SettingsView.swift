...
struct RemoteSettingsView: View {
    ...
    @AppStorage("managerie.appearance") private var appearance: AppAppearance = .system
    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $showAddProfile) {
                ProfileEditorSheet(
                    profile: ServerProfile(name: "", host: "", port: "18092", token: ""),
                    isNew: true,
                    onSave: { profile in
                ...
                ScrollView {
                    VStack(spacing: 14) {
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            editorField(label: "Port", placeholder: "18092", text: $profile.port, keyboard: .numberPad)
