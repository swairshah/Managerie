...
final class PostProcessingRuleStore: ObservableObject {
    ...
    private init() {
        ...
        let managerieDir = appSupport.appendingPathComponent("Managerie", isDirectory: true)
        rulesFileURL = managerieDir.appendingPathComponent("post-processing-rules.json")
    ...
    private static func loadCustomRules(from url: URL) -> [PostProcessingRule] {
        ...
        do {
            ...
            print("Managerie: Failed to load post-processing rules: \(error)")
            return []
        }
    }
    ...
    private func persist(_ rules: [PostProcessingRule]) {
        do {
            ...
            print("Managerie: Failed to persist post-processing rules: \(error)")
        }
    }
}
...
struct PostProcessingTabView: View {
    ...
    @State private var previewText = "Managerie said: “It’s ready.”"
