...
enum ManagerieWebSocketHandshakeError: String, Error {
    case badRequest = "400 Bad Request"
    case upgradeRequired = "426 Upgrade Required"
}

enum ManagerieWebSocketHandshake {
    private static let acceptGUID = "258EAFA5-E914-47DA-95CA-C5AB0DC85B11"

    static func buildUpgradeResponse(from rawHeaders: String) -> Result<String, ManagerieWebSocketHandshakeError> {
...
struct ManagerieWebSocketFrame {
    let opcode: UInt8
    let payload: Data
}

enum ManagerieWebSocketCodec {
    ...
    static func readFrame(from buffer: inout Data, maxPayloadBytes: Int = 2_000_000) -> ManagerieWebSocketFrame? {
        ...
        return ManagerieWebSocketFrame(opcode: opcode, payload: payload)
    }
}
